...
if __name__ == '__main__':
    # input_folder = '/home/aurora/Atlas/Illumina_pipeline_development/samples/join_gz2'
    input_folder = input_dialog()

    wildcard_fn = '*raw*INDEL.vcf'
    ...
    out_vcf_fn = input_folder + '/' + 'variant.raw.INDEL.JOIN.vcf'
